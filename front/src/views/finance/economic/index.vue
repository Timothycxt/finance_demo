<template>
   <div class="app-container">
     <el-alert :closable="false" title="财经新闻列表"  type="success"/>
        <!--顶部查询栏-->
       <!--查询表单-->
    ...
    >
      ...
      <el-table-column align="center" prop="created_at" label="Publish Date" width="200">
        <template slot-scope="scope">
      ...
      <el-table-column label="operation" width="200" align="center">
        <template slot-scope="scope">
          <router-link :to="'/corp/read/'+scope.row.id">
 ...
 <el-pagination
      ...
      @current-change="getEconomicNewList"/>
  </div>

</template>

<script>
import {getEconomicNewPageList}from '@/api/corp'
...
export default {
    ...
    created() {
        // 调用方法
        this.getEconomicNewList()
        
    },
    //写具体的方法调用
    methods: {
        getEconomicNewList (page = 1){// 调用api层获取数据库中的数据
            this.page = page
            getEconomicNewPageList(this.page,this.limit,this.searchObj)
